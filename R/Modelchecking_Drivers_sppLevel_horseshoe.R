...
### meta-analysis drivers-- species level only ####
...
#### spp_richness ####
fit <- readRDS("drivers_spplevelOnly/metaanalysis_drivers_horseshoe_specieslevel_spp_richness.rds")
loo_R2(fit)
...
#### spp_rich_rare ####
fit <- readRDS("drivers_spplevelOnly/metaanalysis_drivers_horseshoe_specieslevel_spp_rich_rare.rds")
...
#### shannonsH ####
fit <- readRDS("drivers_spplevelOnly/metaanalysis_drivers_horseshoe_specieslevel_shannonsH.rds")
...
#### E10 ####
fit <- readRDS("drivers_spplevelOnly/metaanalysis_drivers_horseshoe_specieslevel_E10.rds")
...
#### abundance ####
fit <- readRDS("drivers_spplevelOnly/metaanalysis_drivers_horseshoe_specieslevel_abundance.rds")
...
#### turnover ####
fit <- readRDS("drivers_spplevelOnly/metaanalysis_drivers_horseshoe_specieslevel_turnover.rds")
...
#### F_to ####
fit <- readRDS("drivers_spplevelOnly/metaanalysis_drivers_horseshoe_specieslevel_F_to.rds")
...
#### FRic ####
fit <- readRDS("drivers_spplevelOnly/metaanalysis_drivers_horseshoe_specieslevel_FRic.rds")
...
#### FEve ####
fit <- readRDS("drivers_spplevelOnly/metaanalysis_drivers_horseshoe_specieslevel_FEve.rds")
...
#### FDiv ####
fit <- readRDS("drivers_spplevelOnly/metaanalysis_drivers_horseshoe_specieslevel_FDiv.rds")
...
#### RaoQ ####
fit <- readRDS("drivers_spplevelOnly/metaanalysis_drivers_horseshoe_specieslevel_RaoQ.rds")
...
#### FRed ####
fit <- readRDS("drivers_spplevelOnly/metaanalysis_drivers_horseshoe_specieslevel_FRed.rds")
...
#### alien_SppRich ####
fit <- readRDS("drivers_spplevelOnly/metaanalysis_drivers_horseshoe_specieslevel_alien_SppRich.rds")
...
#### alien_Abund ####
fit <- readRDS("drivers_spplevelOnly/metaanalysis_drivers_horseshoe_specieslevel_alien_Abund.rds")
...
#### abund_nativeSpp ####
fit <- readRDS("drivers_spplevelOnly/metaanalysis_drivers_horseshoe_specieslevel_abund_nativeSpp.rds")
...
#### SppRich_nativeSpp ####
fit <- readRDS("drivers_spplevelOnly/metaanalysis_drivers_horseshoe_specieslevel_SppRich_nativeSpp.rds")
...
#### EPT_SppRich ####
fit <- readRDS("drivers_spplevelOnly/metaanalysis_drivers_horseshoe_specieslevel_EPT_SppRich.rds")
...
#### EPT_Abund ####
fit <- readRDS("drivers_spplevelOnly/metaanalysis_drivers_horseshoe_specieslevel_EPT_Abund.rds")
...
#### insect_SppRich ####
fit <- readRDS("drivers_spplevelOnly/metaanalysis_drivers_horseshoe_specieslevel_insect_SppRich.rds")
...
#### insect_Abund ####
fit <- readRDS("drivers_spplevelOnly/metaanalysis_drivers_horseshoe_specieslevel_insect_Abund.rds")
...
Driver_sppLevel_metaanaly_Ests <- rbind(sr_fixed, srr_fixed, shH_fixed, e10_fixed, abund_fixed, turn_fixed, 
...
write.csv(Driver_sppLevel_metaanaly_Ests, "Driver_sppLevel_metaanaly_Ests.csv")

#### assemble model counts from Parento k diagnostic values from Driver meta-analysis models #####

Driver_sppLevel_metaanaly_parento <- cbind(Count_sr, Count_srr, Count_shH, Count_e10, Count_ab, Count_turn, Count_fto,
...
rownames(Driver_sppLevel_metaanaly_parento) <- c("good[-Inf, 0.5]","ok[0.5, 0.7]","bad[0.7, 1]","verybad[1, Inf]")
write.csv(Driver_sppLevel_metaanaly_parento, "Driver_sppLevel_meta_parento_ModelCounts.csv")
