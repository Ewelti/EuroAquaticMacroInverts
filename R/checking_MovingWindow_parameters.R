...
count_sign$fric_posnegR <- count_sign$site_num_fric_pos/count_sign$site_num_fric_neg
count_sign$fred_posnegR <- count_sign$site_num_fred_pos/count_sign$site_num_fred_neg
...
par(mfrow=c(2,2),mar=c(3,5,0.2,4))
plot(0,0, ylim=c(0.7,2.1),xlim= c(1994,2016), ylab="", xlab="",las=1)
...
box(lwd=2)
title(ylab="# sites with positive/negative", line=3.2)
title(ylab="func. richness trends", line=2.2)
title(xlab="Mean year of moving window", line=2)
...
box(lwd=2)
title(ylab="# sites with positive/negative", line=3.2)
title(ylab="func. redundancy trends", line=2.2)
title(xlab="Mean year of moving window", line=2)
