...
#get data
response_stan <- readRDS("/data/idiv_ess/Ellen/stanTrends_site_level_movingaveragesHTMV3.rds")
...
saveRDS(fit1,file=paste0("metaanalysis_movingaverage_higherthreshold3_",myResponse,"_",myStartYear,".rds"))
