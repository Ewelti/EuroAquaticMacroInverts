...
selectedSites <- read.csv("/data/idiv_ess/Ellen/yearsSampled_since1990.csv")

#subset to those with at least 20 years
selectedSites <- subset(selectedSites, years_sampled>=20)
...
### save output ####
saveRDS(fit1,file=paste0("metaanalysis_movingaverage_higherthreshold2_",myResponse,"_",myStartYear,".rds"))