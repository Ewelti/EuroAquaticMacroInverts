...
yy <- 1:15
plot(yy ~ est, ylab="",xlab="", yaxt="n", las=1, type="n",xlim=c(-0.005,0.005), cex=2)
...
polygon(x=c(sub$Q2.5[3], sub$Q2.5[3], sub$Q97.5[3], sub$Q97.5[3]),y=(yyy1+1), col = 1, border = 1,lwd = 1)
polygon(x=c(sub$Q5[3], sub$Q5[3], sub$Q95[3], sub$Q95[3]),y=(yyy2+1), col = 1, border = 1,lwd = 1)
polygon(x=c(sub$Q10[3], sub$Q10[3], sub$Q90[3], sub$Q90[3]),y=(yyy3+1), col = 1, border = 1,lwd = 1)
polygon(x=c(sub$Q2.5[4], sub$Q2.5[4], sub$Q97.5[4], sub$Q97.5[4]),y=(yyy1+2), col = 1, border = 1,lwd = 1)
polygon(x=c(sub$Q5[4], sub$Q5[4], sub$Q95[4], sub$Q95[4]),y=(yyy2+2), col = 1, border = 1,lwd = 1)
polygon(x=c(sub$Q10[4], sub$Q10[4], sub$Q90[4], sub$Q90[4]),y=(yyy3+2), col = 1, border = 1,lwd = 1)
...
polygon(x=c(sub$Q2.5[12], sub$Q2.5[12], sub$Q97.5[12], sub$Q97.5[12]),y=(yyy1+10), col = 1, border = 1,lwd = 1)
polygon(x=c(sub$Q5[12], sub$Q5[12], sub$Q95[12], sub$Q95[12]),y=(yyy2+10), col = 1, border = 1,lwd = 1)
polygon(x=c(sub$Q10[12], sub$Q10[12], sub$Q90[12], sub$Q90[12]),y=(yyy3+10), col = 1, border = 1,lwd = 1)
...
polygon(x=c(sub$Q2.5[14], sub$Q2.5[14], sub$Q97.5[14], sub$Q97.5[14]),y=(yyy1+12), col = 1, border = 1,lwd = 1)
polygon(x=c(sub$Q5[14], sub$Q5[14], sub$Q95[14], sub$Q95[14]),y=(yyy2+12), col = 1, border = 1,lwd = 1)
polygon(x=c(sub$Q10[14], sub$Q10[14], sub$Q90[14], sub$Q90[14]),y=(yyy3+12), col = 1, border = 1,lwd = 1)
polygon(x=c(sub$Q2.5[15], sub$Q2.5[15], sub$Q97.5[15], sub$Q97.5[15]),y=(yyy1+13), col = 1, border = 1,lwd = 1)
polygon(x=c(sub$Q5[15], sub$Q5[15], sub$Q95[15], sub$Q95[15]),y=(yyy2+13), col = 1, border = 1,lwd = 1)
polygon(x=c(sub$Q10[15], sub$Q10[15], sub$Q90[15], sub$Q90[15]),y=(yyy3+13), col = 1, border = 1,lwd = 1)
...
est <- sub$Estimate[2:16]
plot(yy ~ est, ylab="",xlab="", yaxt="n", las=1, type="n",xlim=c(-0.001,0.001), cex=2)
...
est <- sub$Estimate[2:16]
plot(yy ~ est, ylab="",xlab="", yaxt="n", las=1, type="n",xlim=c(-0.0005,0.0005), cex=2)
