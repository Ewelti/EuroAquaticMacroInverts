...
##save plot
tiff(filename = "plots/Fig4_drivers/Drivers_main_unweighted.tiff", width = 7.8, height = 5, units = 'in', res = 600, compression = 'lzw')
...
est2 <- sub$Estimate[10:12]
est <- c(est1,est2)
plot(yy ~ est, ylab="",xlab="", yaxt="n", las=1, type="n",xlim=c(-0.0074,0.0115), ylim=c(1.7,9.4), cex=2, bty="n")
segments(x0=0,y0=0,x1=0,y1=8.4,lty=2, lwd=2,col="grey60")
axis(2, at=yy, lwd = 0, lwd.ticks = 0, labels=c("ppt sl.","tmax sl.",  "ppt mean", "tmax mean",
				#"str. order", "accum.", "elevation", "slope",
  				"urban","crop", "dam"), las=1,cex.axis=1.3)
...
est2 <- sub$Estimate[10:12]
est <- c(est1,est2)
plot(yy ~ est, ylab="",xlab="", yaxt="n", las=1, type="n",xlim=c(-0.0039,0.0093), ylim=c(1.7,9.4), cex=2, bty="n")
segments(x0=0,y0=0,x1=0,y1=8.4,lty=2, lwd=2,col="grey60")
title(xlab="Estimate", line=2.4,cex.lab=1.3)
...
est2 <- sub$Estimate[10:12]
est <- c(est1,est2)
plot(yy ~ est, ylab="",xlab="", yaxt="n", las=1, type="n",xlim=c(-0.0012,0.0009), ylim=c(1.7,9.4), cex=2, bty="n")
segments(x0=0,y0=0,x1=0,y1=8.4,lty=2, lwd=2,col="grey60")
title(xlab="Estimate", line=2.4,cex.lab=1.3)
...
est2 <- sub$Estimate[10:12]
est <- c(est1,est2)
plot(yy ~ est, ylab="",xlab="", yaxt="n", las=1, type="n",xlim=c(-0.00204,0.0016), ylim=c(1.7,9.4), cex=2, bty="n")
segments(x0=0,y0=0,x1=0,y1=8.4,lty=2, lwd=2,col="grey60")
title(xlab="Estimate", line=2.4,cex.lab=1.3)
...
est2 <- sub$Estimate[10:12]
est <- c(est1,est2)
plot(yy ~ est, ylab="",xlab="", yaxt="n", las=1, type="n",xlim=c(-0.0029,0.0012), ylim=c(1.7,9.4), cex=2, bty="n")
segments(x0=0,y0=0,x1=0,y1=8.4,lty=2, lwd=2,col="grey60")
title(xlab="Estimate", line=2.4,cex.lab=1.3)
...
est2 <- sub$Estimate[10:12]
est <- c(est1,est2)
plot(yy ~ est, ylab="",xlab="", yaxt="n", las=1, type="n",xlim=c(-0.0041,0.0011), ylim=c(1.7,9.4), cex=2, bty="n")
segments(x0=0,y0=0,x1=0,y1=8.4,lty=2, lwd=2,col="grey60")
title(xlab="Estimate", line=2.4,cex.lab=1.3)
...
est2 <- sub$Estimate[10:12]
est <- c(est1,est2)
plot(yy ~ est, ylab="",xlab="", yaxt="n", las=1, type="n",xlim=c(-0.016,0.0132), ylim=c(1.7,9.4), cex=2, bty="n")
segments(x0=0,y0=0,x1=0,y1=8.4,lty=2, lwd=2,col="grey60")
title(xlab="Estimate", line=2.4,cex.lab=1.3)
