...
# attach data
drivEst <- read.csv("outputs/Driver_lasso_metaanaly_Ests.csv")
head(drivEst)
...
##save plot
tiff(filename = "plots/Fig4_drivers/Drivers_main_lasso.tiff", width = 7.8, height = 5, units = 'in', res = 600, compression = 'lzw')
