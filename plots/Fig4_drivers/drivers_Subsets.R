...
##save plot
tiff(filename = "plots/Fig4_drivers/Drivers_Subsets.tiff", width = 7.8, height = 5, units = 'in', res = 600, compression = 'lzw')
...
legend("topleft", legend=("a) Alien richness"), bty="n", cex=1.3)
mm <- cbind(yy,est)
...
axis(2, at=yy, lwd = 0, lwd.ticks = 0, labels=c("ppt sl.","tmax sl.",  "ppt mean", "tmax mean",
				#"str. order", "accum.", "elevation", "slope",
  				"urban","crop", "dam"), las=1,cex.axis=1.3)
title(xlab="Estimate", line=2.4,cex.lab=1.3)
legend("topleft", legend=("e) Alien abundance"), bty="n", cex=1.3)
mm <- cbind(yy,est)
mm_neg <- as.data.frame(mm[ which(est < 0),])
mm_pos <- as.data.frame(mm[ which(est > 0),])
#points(yy ~ est, pch="l",cex=2.2,col="white")
...
segments(x0=0,y0=0,x1=0,y1=8.4,lty=2, lwd=2,col="grey60")
title(xlab="Estimate", line=2.4,cex.lab=1.3)
legend("topleft", legend=("b) Native richness"), bty="n", cex=1.3)
mm <- cbind(yy,est)
mm_neg <- as.data.frame(mm[ which(est < 0),])
mm_pos <- as.data.frame(mm[ which(est > 0),])
#points(yy ~ est, pch="l",cex=2.2,col="white")
...
segments(x0=0,y0=0,x1=0,y1=8.4,lty=2, lwd=2,col="grey60")
title(xlab="Estimate", line=2.4,cex.lab=1.3)
legend("topleft", legend=("f) Native abundance"), bty="n", cex=1.3)
mm <- cbind(yy,est)
mm_neg <- as.data.frame(mm[ which(est < 0),])
mm_pos <- as.data.frame(mm[ which(est > 0),])
#points(yy ~ est, pch="l",cex=2.2,col="white")
...
segments(x0=0,y0=0,x1=0,y1=8.4,lty=2, lwd=2,col="grey60")
title(xlab="Estimate", line=2.4,cex.lab=1.3)
legend("topleft", legend=("c) EPT richness"), bty="n", cex=1.3)
mm <- cbind(yy,est)
mm_neg <- as.data.frame(mm[ which(est < 0),])
mm_pos <- as.data.frame(mm[ which(est > 0),])
#points(yy ~ est, pch="l",cex=2.2,col="white")
...
segments(x0=0,y0=0,x1=0,y1=8.4,lty=2, lwd=2,col="grey60")
title(xlab="Estimate", line=2.4,cex.lab=1.3)
legend("topleft", legend=("g) EPT abundance"), bty="n", cex=1.3)
mm <- cbind(yy,est)
mm_neg <- as.data.frame(mm[ which(est < 0),])
mm_pos <- as.data.frame(mm[ which(est > 0),])
#points(yy ~ est, pch="l",cex=2.2,col="white")
...
segments(x0=0,y0=0,x1=0,y1=8.4,lty=2, lwd=2,col="grey60")
title(xlab="Estimate", line=2.4,cex.lab=1.3)
legend("topleft", legend=("d) Insect richness"), bty="n", cex=1.3)
mm <- cbind(yy,est)
mm_neg <- as.data.frame(mm[ which(est < 0),])
mm_pos <- as.data.frame(mm[ which(est > 0),])
points(mm_neg$yy ~ mm_neg$est, pch="l",cex=2,col="firebrick2")
...
est2 <- sub$Estimate[10:12]
est <- c(est1,est2)
plot(yy ~ est, ylab="",xlab="", yaxt="n", las=1, type="n",xlim=c(-0.003,0.005), ylim=c(1.7,9.4), cex=2, bty="n")
segments(x0=0,y0=0,x1=0,y1=8.4,lty=2, lwd=2,col="grey60")
title(xlab="Estimate", line=2.4,cex.lab=1.3)
legend("topleft", legend=("h) Insect abundance"), bty="n", cex=1.3)
mm <- cbind(yy,est)
mm_neg <- as.data.frame(mm[ which(est < 0),])
mm_pos <- as.data.frame(mm[ which(est > 0),])
#points(yy ~ est, pch="l",cex=2.2,col="white")
