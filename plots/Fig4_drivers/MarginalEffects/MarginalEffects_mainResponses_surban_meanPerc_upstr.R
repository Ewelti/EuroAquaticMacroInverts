...
driv_m <- median(meta$urban_meanPerc_upstr,na.rm=T)
driv_sd <- sd(meta$urban_meanPerc_upstr,na.rm=T)

tiff(filename = "plots/MarginalEffects/Marg_main_urban.tiff", width = 10, height = 5, units = 'in', res = 600, compression = 'lzw')
...
##richness
ma <- readRDS("outputs/Driver_marginalEffects/preds-surban_meanPerc_upstr-spp_richness.rds")
head(ma)
driv <- (ma$surban_meanPerc_upstr*driv_sd+driv_m)*100
...
##func richness
ma <- readRDS("outputs/Driver_marginalEffects/preds-surban_meanPerc_upstr-FRic.rds")
driv <- (ma$surban_meanPerc_upstr*driv_sd+driv_m)*100
plot(1, type="n", xlim=c(min(driv),max(driv)), ylim=c(min(ma$lower),max(ma$upper)),xaxs="i",las=1,ylab="",xlab="")
polygon(x = c(-1000, -1000, 1000, 1000), y = c(-1000, 0, 0, -1000), col = "mistyrose1", lty = 0)   
polygon(c(driv, rev(driv)), c(ma$lower, rev(ma$upper)), col = "lightgrey", lty = 0)
...
plot(0, xaxt = 'n', yaxt = 'n', bty = 'n', pch = '', ylab = '', xlab = '')
title(xlab="% area urban upstream", line=-0.5, cex.lab=1.4)

##abundance
ma <- readRDS("outputs/Driver_marginalEffects/preds-surban_meanPerc_upstr-abundance.rds")
driv <- (ma$surban_meanPerc_upstr*driv_sd+driv_m)*100
plot(1, type="n", xlim=c(min(driv),max(driv)), ylim=c(min(ma$lower),max(ma$upper)),xaxs="i",las=1,ylab="",xlab="")
polygon(x = c(-1000, -1000, 1000, 1000), y = c(-1000, 0, 0, -1000), col = "mistyrose1", lty = 0)   
polygon(c(driv, rev(driv)), c(ma$lower, rev(ma$upper)), col = "lightgrey", lty = 0)
...
ma <- readRDS("outputs/Driver_marginalEffects/preds-surban_meanPerc_upstr-FRed.rds")
driv <- (ma$surban_meanPerc_upstr*driv_sd+driv_m)*100
plot(1, type="n", xlim=c(min(driv),max(driv)), ylim=c(min(ma$lower),max(ma$upper)),xaxs="i",las=1,ylab="",xlab="")
polygon(x = c(-1000, -1000, 1000, 1000), y = c(-1000, 0, 0, -1000), col = "mistyrose1", lty = 0)   
polygon(c(driv, rev(driv)), c(ma$lower, rev(ma$upper)), col = "lightgrey", lty = 0)
...
##evenness
ma <- readRDS("outputs/Driver_marginalEffects/preds-surban_meanPerc_upstr-E10.rds")
driv <- (ma$surban_meanPerc_upstr*driv_sd+driv_m)*100
plot(1, type="n", xlim=c(min(driv),max(driv)), ylim=c(min(ma$lower),max(ma$upper)),xaxs="i",las=1,ylab="",xlab="")
polygon(x = c(-1000, -1000, 1000, 1000), y = c(-1000, 0, 0, -1000), col = "mistyrose1", lty = 0)   
polygon(c(driv, rev(driv)), c(ma$lower, rev(ma$upper)), col = "lightgrey", lty = 0)
...
##func evenness
ma <- readRDS("outputs/Driver_marginalEffects/preds-surban_meanPerc_upstr-FEve.rds")
driv <- (ma$surban_meanPerc_upstr*driv_sd+driv_m)*100
plot(1, type="n", xlim=c(min(driv),max(driv)), ylim=c(min(ma$lower),max(ma$upper)),xaxs="i",las=1,ylab="",xlab="")
polygon(x = c(-1000, -1000, 1000, 1000), y = c(-1000, 0, 0, -1000), col = "mistyrose1", lty = 0)   
polygon(c(driv, rev(driv)), c(ma$lower, rev(ma$upper)), col = "lightgrey", lty = 0)
...
##turnover
ma <- readRDS("outputs/Driver_marginalEffects/preds-surban_meanPerc_upstr-turnover.rds")
driv <- (ma$surban_meanPerc_upstr*driv_sd+driv_m)*100
plot(1, type="n", xlim=c(min(driv),max(driv)), ylim=c(min(ma$lower),max(ma$upper)),xaxs="i",las=1,ylab="",xlab="")
polygon(x = c(-1000, -1000, 1000, 1000), y = c(-1000, 0, 0, -1000), col = "mistyrose1", lty = 0)   
polygon(c(driv, rev(driv)), c(ma$lower, rev(ma$upper)), col = "lightgrey", lty = 0)
...
##func turnover
ma <- readRDS("outputs/Driver_marginalEffects/preds-surban_meanPerc_upstr-F_to.rds")
driv <- (ma$surban_meanPerc_upstr*driv_sd+driv_m)*100
plot(1, type="n", xlim=c(min(driv),max(driv)), ylim=c(min(ma$lower),max(ma$upper)),xaxs="i",las=1,ylab="",xlab="")
polygon(x = c(-1000, -1000, 1000, 1000), y = c(-1000, 0, 0, -1000), col = "mistyrose1", lty = 0)   
polygon(c(driv, rev(driv)), c(ma$lower, rev(ma$upper)), col = "lightgrey", lty = 0)
