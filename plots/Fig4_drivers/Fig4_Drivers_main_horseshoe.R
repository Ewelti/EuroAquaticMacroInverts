...
##save plot
#tiff(filename = "plots/Fig4_drivers/Fig4._Drivers_main_horseshoe.tiff", width = 7.8, height = 5, units = 'in', res = 600, compression = 'lzw')
pdf("plots/Fig4_drivers/Fig4_Drivers_main_horseshoe.pdf", width = 7.8, height = 5)
...
legend("topright", legend=("Taxon richness"), bty="n", cex=1.3)
legend("topleft", legend=as.expression(bquote(bold("a"))), bty="n", cex=1.3)
mm <- cbind(yy,est)
...
axis(2, at=yy, lwd = 0, lwd.ticks = 0, labels=c("ppt sl.","tmax sl.",  "ppt mean", "tmax mean",
				#"str. order", "accum.", "elevation", "slope",
  				"urban","crop", "dam"), las=1,cex.axis=1.3)
title(xlab="Estimate", line=2.4,cex.lab=1.3)
legend("topright", legend=("Func. richness"), bty="n", cex=1.3)
legend("topleft", legend=as.expression(bquote(bold("e"))), bty="n", cex=1.3)
...
segments(x0=0,y0=0,x1=0,y1=8.4,lty=2, lwd=2,col="grey60")
title(xlab="Estimate", line=2.4,cex.lab=1.3)
legend("topright", legend=("Abundance"), bty="n", cex=1.3)
legend("topleft", legend=as.expression(bquote(bold("b"))), bty="n", cex=1.3)
...
segments(x0=0,y0=0,x1=0,y1=8.4,lty=2, lwd=2,col="grey60")
title(xlab="Estimate", line=2.4,cex.lab=1.3)
legend("topright", legend=("Func. redundancy"), bty="n", cex=1.3)
legend("topleft", legend=as.expression(bquote(bold("f"))), bty="n", cex=1.3)
...
segments(x0=0,y0=0,x1=0,y1=8.4,lty=2, lwd=2,col="grey60")
title(xlab="Estimate", line=2.4,cex.lab=1.3)
legend("topright", legend=("Evenness"), bty="n", cex=1.3)
legend("topleft", legend=as.expression(bquote(bold("c"))), bty="n", cex=1.3)
...
segments(x0=0,y0=0,x1=0,y1=8.4,lty=2, lwd=2,col="grey60")
title(xlab="Estimate", line=2.4,cex.lab=1.3)
legend("topright", legend=("Func. evenness"), bty="n", cex=1.3)
legend("topleft", legend=as.expression(bquote(bold("g"))), bty="n", cex=1.3)
...
segments(x0=0,y0=0,x1=0,y1=8.4,lty=2, lwd=2,col="grey60")
title(xlab="Estimate", line=2.4,cex.lab=1.3)
legend("topright", legend=("Turnover"), bty="n", cex=1.3)
legend("topleft", legend=as.expression(bquote(bold("d"))), bty="n", cex=1.3)
...
segments(x0=0,y0=0,x1=0,y1=8.4,lty=2, lwd=2,col="grey60")
title(xlab="Estimate", line=2.4,cex.lab=1.3)
legend("topright", legend=("Func. turnover"), bty="n", cex=1.3)
legend("topleft", legend=as.expression(bquote(bold("h"))), bty="n", cex=1.3)
