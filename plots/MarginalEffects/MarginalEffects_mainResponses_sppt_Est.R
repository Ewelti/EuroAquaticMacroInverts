...
driv_m <- median(meta$ppt_Est)
driv_sd <- sd(meta$ppt_Est)

tiff(filename = "plots/MarginalEffects/Marg_main_SlopePrecip.tiff", width = 10, height = 5, units = 'in', res = 600, compression = 'lzw')
...
##richness
ma <- readRDS("outputs/Driver_marginalEffects/preds-sppt_Est-spp_richness.rds")
head(ma)
driv <- ma$sppt_Est*driv_sd+driv_m
...
##func richness
ma <- readRDS("outputs/Driver_marginalEffects/preds-sppt_Est-FRic.rds")
driv <- ma$sppt_Est*driv_sd+driv_m
plot(1, type="n", xlim=c(min(driv),max(driv)), ylim=c(min(ma$lower),max(ma$upper)),xaxs="i",las=1,ylab="",xlab="")
polygon(x = c(-1000, -1000, 1000, 1000), y = c(-1000, 0, 0, -1000), col = "mistyrose1", lty = 0)   
polygon(c(driv, rev(driv)), c(ma$lower, rev(ma$upper)), col = "lightgrey", lty = 0)
...
plot(0, xaxt = 'n', yaxt = 'n', bty = 'n', pch = '', ylab = '', xlab = '')
title(xlab="Precipitation trend", line=-0.5, cex.lab=1.4)

##abundance
ma <- readRDS("outputs/Driver_marginalEffects/preds-sppt_Est-abundance.rds")
driv <- ma$sppt_Est*driv_sd+driv_m
plot(1, type="n", xlim=c(min(driv),max(driv)), ylim=c(min(ma$lower),max(ma$upper)),xaxs="i",las=1,ylab="",xlab="")
polygon(x = c(-1000, -1000, 1000, 1000), y = c(-1000, 0, 0, -1000), col = "mistyrose1", lty = 0)   
polygon(c(driv, rev(driv)), c(ma$lower, rev(ma$upper)), col = "lightgrey", lty = 0)
...
ma <- readRDS("outputs/Driver_marginalEffects/preds-sppt_Est-FRed.rds")
driv <- ma$sppt_Est*driv_sd+driv_m
plot(1, type="n", xlim=c(min(driv),max(driv)), ylim=c(min(ma$lower),max(ma$upper)),xaxs="i",las=1,ylab="",xlab="")
polygon(x = c(-1000, -1000, 1000, 1000), y = c(-1000, 0, 0, -1000), col = "mistyrose1", lty = 0)   
polygon(c(driv, rev(driv)), c(ma$lower, rev(ma$upper)), col = "lightgrey", lty = 0)
...
##evenness
ma <- readRDS("outputs/Driver_marginalEffects/preds-sppt_Est-E10.rds")
driv <- ma$sppt_Est*driv_sd+driv_m
plot(1, type="n", xlim=c(min(driv),max(driv)), ylim=c(min(ma$lower),max(ma$upper)),xaxs="i",las=1,ylab="",xlab="")
polygon(x = c(-1000, -1000, 1000, 1000), y = c(-1000, 0, 0, -1000), col = "mistyrose1", lty = 0)   
polygon(c(driv, rev(driv)), c(ma$lower, rev(ma$upper)), col = "lightgrey", lty = 0)
...
##func evenness
ma <- readRDS("outputs/Driver_marginalEffects/preds-sppt_Est-FEve.rds")
driv <- ma$sppt_Est*driv_sd+driv_m
plot(1, type="n", xlim=c(min(driv),max(driv)), ylim=c(min(ma$lower),max(ma$upper)),xaxs="i",las=1,ylab="",xlab="")
polygon(x = c(-1000, -1000, 1000, 1000), y = c(-1000, 0, 0, -1000), col = "mistyrose1", lty = 0)   
polygon(c(driv, rev(driv)), c(ma$lower, rev(ma$upper)), col = "lightgrey", lty = 0)
...
##turnover
ma <- readRDS("outputs/Driver_marginalEffects/preds-sppt_Est-turnover.rds")
driv <- ma$sppt_Est*driv_sd+driv_m
plot(1, type="n", xlim=c(min(driv),max(driv)), ylim=c(min(ma$lower),max(ma$upper)),xaxs="i",las=1,ylab="",xlab="")
polygon(x = c(-1000, -1000, 1000, 1000), y = c(-1000, 0, 0, -1000), col = "mistyrose1", lty = 0)   
polygon(c(driv, rev(driv)), c(ma$lower, rev(ma$upper)), col = "lightgrey", lty = 0)
...
##func turnover
ma <- readRDS("outputs/Driver_marginalEffects/preds-sppt_Est-F_to.rds")
driv <- ma$sppt_Est*driv_sd+driv_m
plot(1, type="n", xlim=c(min(driv),max(driv)), ylim=c(min(ma$lower),max(ma$upper)),xaxs="i",las=1,ylab="",xlab="")
polygon(x = c(-1000, -1000, 1000, 1000), y = c(-1000, 0, 0, -1000), col = "mistyrose1", lty = 0)   
polygon(c(driv, rev(driv)), c(ma$lower, rev(ma$upper)), col = "lightgrey", lty = 0)
