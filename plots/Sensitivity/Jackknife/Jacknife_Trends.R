...
yy <- c(22:1)
plot(yy ~ sub$Estimate, ylab="",xlab="", yaxt="n", las=1, type="n",xlim=c(min(sub$l.95..CI),max(sub$u.95..CI)), cex=2,ylim=c(0.5,22.5))
polygon(x=c(-100,-100,0,0),
        y=c(-4,29,29,-4), col = "grey80", border = "grey80")
points(yy ~ sub$Estimate, pch=19, cex=1)
arrows(sub$l.95..CI, yy, sub$u.95..CI, yy, length=0.05, angle=90, code=3, lwd=2)
