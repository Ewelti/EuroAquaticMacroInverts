...
#evenness map
sr_sites <- resp[!is.na(resp$E10),]
sr_sites <- sr_sites[order(sr_sites$E10),]
head(sr_sites)
...
sr_pos <- sr_sites$trend_perc[(1:length(sr_sites$trend_perc))[sr_sites$E10 > 0]]
...
legend(-12.5,75.2,legend=expression(paste("a) Evenness (%", y^-1, ")", sep = "")),text.col=c("white"),bty='n',cex=1.7)

############################Turnover#######################################

sr_sites <- resp[!is.na(resp$turnover),]
sr_sites <- sr_sites[order(sr_sites$turnover),]
head(sr_sites)
...
sr_pos <- sr_sites$trend_perc[(1:length(sr_sites$trend_perc))[sr_sites$turnover > 0]]
...
legend(-9.15, 72.3,title="",legend=lg2,col =c('midnightblue','white','white','white','white','white','red4'),text.col=c("white"),lty=1,lwd=1,bty="n",cex=0.95)
segments(x, y, x2, y, col= unique(sr_sites$sr_col),lwd=3)
legend(-12.5,75.2,legend=expression(paste("b) Turnover (%", y^-1, ")", sep = "")),text.col=c("white"),bty='n',cex=1.7)

############################Shannon's H#######################################

sr_sites <- resp[!is.na(resp$shannonsH),]
sr_sites <- sr_sites[order(sr_sites$shannonsH),]
head(sr_sites)
...
sr_pos <- sr_sites$trend_perc[(1:length(sr_sites$trend_perc))[sr_sites$shannonsH > 0]]
...
legend(-9.15, 72.3,title="",legend=lg2,col =c('midnightblue','white','white','white','white','white','red4'),text.col=c("white"),lty=1,lwd=1,bty="n",cex=0.95)
segments(x, y, x2, y, col= unique(sr_sites$sr_col),lwd=3)
legend(-12.5,75.2,legend=expression(paste("c) Shannon's H (%", y^-1, ")", sep = "")),text.col=c("white"),bty='n',cex=1.7)


############################Rarefied Richness#######################################

sr_sites <- resp[!is.na(resp$spp_rich_rare),]
sr_sites <- sr_sites[order(sr_sites$spp_rich_rare),]
head(sr_sites)
...
sr_pos <- sr_sites$trend_perc[(1:length(sr_sites$trend_perc))[sr_sites$spp_rich_rare > 0]]
...
legend(-9.15, 72.3,title="",legend=lg2,col =c('midnightblue','white','white','white','white','white','red4'),text.col=c("white"),lty=1,lwd=1,bty="n",cex=0.95)
segments(x, y, x2, y, col= unique(sr_sites$sr_col),lwd=3)
legend(-12.5,75.2,legend=expression(paste("d) Rarefied richness (%", y^-1, ")", sep = "")),text.col=c("white"),bty='n',cex=1.7)
