...
tiff(filename = "plots/Countries_yr.tiff", width =5, height = 8, units = 'in', res = 600, compression = 'lzw')
...
legend(x=2,y=1400, rownames(sites), fill = colors, border = colors, bty = "n",cex=1.7)
