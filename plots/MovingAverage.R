...
# attach data
MA <- read.csv("outputs/movingAve_YrEsts_6yr.csv")
...
plot(SRs$Estimate~SRs$meanYr,ylab="", cex=1.5, xlab="", type="n", las=1, ylim=c(-0.8,2.55))
...
plot(SRs$Estimate~SRs$meanYr,ylab="", cex=1.5, xlab="", type="n", las=1, ylim=c(-0.57,0.4))
