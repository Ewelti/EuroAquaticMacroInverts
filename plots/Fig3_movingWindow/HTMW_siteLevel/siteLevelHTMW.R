...
#### Taxon Richness
tiff(filename = "plots/Fig3_movingWindow/HTMW_siteLevel/HTMW_siteLevel_TaxonRich.tiff", width = 12, height = 8, units = 'in', res = 600, compression = 'lzw')
...
polygon(x = c(0, 0, 2040, 2040), y = c(-1000, 0, 0, -1000), col ="coral1", border = NA)
polygon(x = c(0, 0, 2040, 2040), y = c(1000, 0, 0, 1000), col ="lightsteelblue1", border = NA)
...
#### Abundance
tiff(filename = "plots/Fig3_movingWindow/HTMW_siteLevel/HTMW_siteLevel_Abundance.tiff", width = 12, height = 8, units = 'in', res = 600, compression = 'lzw')
...
#### FRic
tiff(filename = "plots/Fig3_movingWindow/HTMW_siteLevel/HTMW_siteLevel_FRic.tiff", width = 12, height = 8, units = 'in', res = 600, compression = 'lzw')
...
#### FRed
tiff(filename = "plots/Fig3_movingWindow/HTMW_siteLevel/HTMW_siteLevel_FRed.tiff", width = 12, height = 9, units = 'in', res = 600, compression = 'lzw')
