...
#####################Functional metrics ##############################
#### Functional Richness #####
FRic <- subset(response_stan, Response == "spp_richness")
FRic <- FRic$estimate[!is.na(FRic$estimate)]
#average functional richness= 1372.61497
ave_FRic <- 1372.61497
percChange_perYr<-(FRic/ave_FRic)*100
d <- density(percChange_perYr)
a <- (max(d$y)+(max(d$y)/10)) *-4
b <- (max(d$y)+(max(d$y)/10))*1
plot(d, main="",ylab="",xlab="",cex.lab=2,xlim=c(-10,10),ylim=c(a,b),col="white",yaxt='n')
...
stand_FRic <- lapply(FRic_Est[,2:11],"*", 100/ave_FRic)
yy <- (4/5*(b-a)+a)
points(x=stand_FRic$Estimate, y=yy, lwd=2,pch="l",cex=1.5)
polygon(x=c(stand_FRic$Q1, stand_FRic$Q1, stand_FRic$Q99, stand_FRic$Q99),
        y=c(yy,yy,yy,yy),
        col = 1,border = 1,lwd = 2)
...
polygon(x=c(stand_RaoQ$Q1, stand_RaoQ$Q1, stand_RaoQ$Q99, stand_RaoQ$Q99),
        y=c(yy,yy,yy,yy),
        col = 1,border = 1,lwd = 2)
...
percChange_perYr<-(FDiv/ave_FDiv)*100
d <- density(percChange_perYr)
a <- (max(d$y)+(max(d$y)/10)) *-2
b <- (max(d$y)+(max(d$y)/10))*3
par(new=TRUE)
...
stand_FDiv <- lapply(FDiv_Est[,2:11],"*",100/ave_FDiv)
yy <- (2/5*(b-a)+a)
points(x=stand_FDiv$Estimate, y=yy, lwd=2,pch="l",cex=1.5)
polygon(x=c(stand_FDiv$Q1, stand_FDiv$Q1, stand_FDiv$Q99, stand_FDiv$Q99),
        y=c(yy,yy,yy,yy),
        col = 1,border = 1,lwd = 2)
...
polygon(x=c(stand_FEve$Q1, stand_FEve$Q1, stand_FEve$Q99, stand_FEve$Q99),
        y=c(yy,yy,yy,yy),
        col = 1,border = 1,lwd = 2)
...
percChange_perYr<-(F_to/ave_F_to)*100
d <- density(percChange_perYr)
a <- (max(d$y)+(max(d$y)/10)) *0
b <- (max(d$y)+(max(d$y)/10))*5
par(new=TRUE)
...
stand_F_to <- lapply(F_to_Est[,2:11],"*",100/ave_F_to)
yy <- (0/5*(b-a)+a)
points(x=stand_F_to$Estimate, y=yy, lwd=2,pch="l",cex=1.5)
polygon(x=c(stand_F_to$Q1, stand_F_to$Q1, stand_F_to$Q99, stand_F_to$Q99),
        y=c(yy,yy,yy,yy),
        col = 1,border = 1,lwd = 2)
...
polygon(x=c(stand_alien_SppRich$Q1, stand_alien_SppRich$Q1, stand_alien_SppRich$Q99, stand_alien_SppRich$Q99),
        y=c(yy,yy,yy,yy),
        col = 1,border = 1,lwd = 2)
...
polygon(x=c(stand_alien_Abund$Q1, stand_alien_Abund$Q1, stand_alien_Abund$Q99, stand_alien_Abund$Q99),
        y=c(yy,yy,yy,yy),
        col = 1,border = 1,lwd = 2)
...
polygon(x=c(stand_SppRich_nativeSpp$Q1, stand_SppRich_nativeSpp$Q1, stand_SppRich_nativeSpp$Q99, stand_SppRich_nativeSpp$Q99),
        y=c(yy,yy,yy,yy),
        col = 1,border = 1,lwd = 2)
...
polygon(x=c(stand_abund_nativeSpp$Q1, stand_abund_nativeSpp$Q1, stand_abund_nativeSpp$Q99, stand_abund_nativeSpp$Q99),
        y=c(yy,yy,yy,yy),
        col = 1,border = 1,lwd = 2)
...
polygon(x=c(stand_EPT_SppRich$Q1, stand_EPT_SppRich$Q1, stand_EPT_SppRich$Q99, stand_EPT_SppRich$Q99),
        y=c(yy,yy,yy,yy),
        col = 1,border = 1,lwd = 2)
...
polygon(x=c(stand_EPT_Abund$Q1, stand_EPT_Abund$Q1, stand_EPT_Abund$Q99, stand_EPT_Abund$Q99),
        y=c(yy,yy,yy,yy),
        col = 1,border = 1,lwd = 2)
...
polygon(x=c(stand_insect_SppRich$Q1, stand_insect_SppRich$Q1, stand_insect_SppRich$Q99, stand_insect_SppRich$Q99),
        y=c(yy,yy,yy,yy),
        col = 1,border = 1,lwd = 2)
...
polygon(x=c(stand_insect_Abund$Q1, stand_insect_Abund$Q1, stand_insect_Abund$Q99, stand_insect_Abund$Q99),
        y=c(yy,yy,yy,yy),
        col = 1,border = 1,lwd = 2)
