...
tiff(filename = "Dam_map.tiff", width = 6.8, height = 5.8, units = 'in', res = 600, compression = 'lzw')
...
########################  CLIMATE  #####################
tiff(filename = "Climate_maps.tiff", width = 11, height = 11, units = 'in', res = 600, compression = 'lzw')
...
########################  LAND COVER  #####################
tiff(filename = "Landcover_maps.tiff", width = 11, height = 11, units = 'in', res = 600, compression = 'lzw')
...
legend(-9, 72.3,title="",legend=lg,col =pal_(8),lty=1,lwd=1,bty="n",cex=0.85)
segments(x, y, x2, y, col= unique(sr_sites$sr_col),lwd=3)
legend(-10.2,72.7,legend=c("Mean % Urban"),bty='n')
...
legend(-9, 72.3,title="",legend=lg,col =pal_(8),lty=1,lwd=1,bty="n",cex=0.85)
segments(x, y, x2, y, col= unique(sr_sites$sr_col),lwd=3)
legend(-10.2,72.7,legend=c("Mean % Crop"),bty='n')
...
tiff(filename = "StreamCharaterictics_maps.tiff", width = 11, height = 11, units = 'in', res = 600, compression = 'lzw')
...
legend(-10.2,72.7,legend=c("Flow Accumulation (km^2)"),bty='n')
